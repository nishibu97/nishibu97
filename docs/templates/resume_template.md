...
業界5年目のTypeScript/Python を中心としたフルスタックエンジニアです。
...
- Gitlab、GitHub , GitHub Actions, Gitlab CI/CD
...
{% for project in company.projects | sort(attribute='project_id', reverse=True) %}
